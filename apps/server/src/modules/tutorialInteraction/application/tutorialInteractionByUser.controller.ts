...
@Controller('/v1/users')
export class TutorialInteractionByUserController {
  constructor(
  ...
  @Get('/user/:userId/tutorialInteractions')
  async findManyUserId(
    ...
    const items = await this.tutorialInteractionDomainFacade.findManyByUser(
      parent,
      queryOptions,
    )
  ...
  @Post('/user/:userId/tutorialInteractions')
